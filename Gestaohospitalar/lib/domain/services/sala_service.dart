...
//     final List<Map<String, dynamic>> maps = await db.query('sala', orderBy: 'nome_sala');
//     return maps.map((m) => Sala.fromMap(m)).toList();
//   }

//   Future<void> cadastrar(Sala sala) async {
//     final db = await _getDb();
//     await db.insert('sala', sala.toMap(), conflictAlgorithm: ConflictAlgorithm.replace);
//   }

//   Future<void> excluir(int id) async {
//     final db = await _getDb();
//     await db.delete('sala', where: 'id_sala = ?', whereArgs: [id]);
//   }
